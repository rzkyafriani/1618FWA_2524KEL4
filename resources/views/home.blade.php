    ...
    <div id="container">
      <div id="banner">
        <ul class="bjqs">
          ...
          <li><img src="{{asset('web/images/syahrini.jpg')}}"></li>
        </ul>
      </div>
   </div>
   <script>
        ...
        <div class="grid">
                <div class="tariff">
                        <div class="text">
                            ...
                            <p>Goyang Vista menghadirkan hiburan karaoke keluarga sejak 2017. Dilengkapi dengan kualitas audio video yg prima, koleksi lagu yang lengkap, peralatan yg canggih, sistem layar sentuh, desain ruangan yang modern dan berbagai fasilitas lainnya untuk memberikan pengalaman bernyanyi yang tak terlupakan. Gass </p
