...
<div class="wrap">
    ...
    <div class="menu">
            <ul>
                ...
                <li class="active"><a href="{{url('daftar_menu')}}">Menu</a></li>
    ...
    <div id="container">
      <div id="banner">
        <ul class="bjqs">
          <li><img src="{{asset('web/images/soto1.jpg')}}"></li>
          <li><img src="{{asset('web/images/ayampotong.jpg')}}"></li>
          <li><img src="{{asset('web/images/nasi1.jpg')}}"></li>
          <li><img src="{{asset('web/images/nasi.jpg')}}"></li>
           <li><img src="{{asset('web/images/mcflurry1.jpg')}}"></li>
           <li><img src="{{asset('web/images/mcflurry2..jpg')}}"></li>
        </ul>
      </div>
   </div>
   <script>
